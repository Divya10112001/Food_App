...
public class Category extends AppCompatActivity  implements Adapter_category_inside.OnItemClickListener {
    ...
    private void dialogboxfun() {
        AlertDialog.Builder builder2 = new AlertDialog.Builder(Category.this);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(Category.this, Ingredient.class);
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        JSONObject meals = jsonArray.getJSONObject(i);
                                ...
                                adapter.setOnItemClickListener(Category.this);
